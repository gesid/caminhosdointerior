...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<InformativeMessageOutputDto> handleEntityNotFoundException(
  ...
  public ResponseEntity<InformativeMessageOutputDto> handleEntityConflictException(
  ...
  public ResponseEntity<InformativeMessageOutputDto> handleBadRequestException(
    Exception exception,
    HttpServletRequest request
  ) {
    InformativeMessageOutputDto informativeMessage = new InformativeMessageOutputDto();
